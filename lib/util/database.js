...
// Reset videos marked as 'download failed'
exports.resetDownloadFailedVideos = () => db.updateAsync({ status: constants.STATUS_DOWNLOAD_FAILED }, { $set: { status: constants.STATUS_NOT_DOWNLOADED } }, { multi: true })
